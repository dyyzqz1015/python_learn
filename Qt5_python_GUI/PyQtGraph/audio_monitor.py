...
import sys
from Qt5_python_GUI.PyQtGraph.ui_main import *
import numpy as np
import pyqtgraph
from Qt5_python_GUI.PyQtGraph import SWHear
...
class ExampleApp(QMainWindow, Ui_MainWindow):
    def __init__(self, parent=None):
        ...
        self.setupUi(self)
        self.grFFT.plotItem.showGrid(True, True, 0.7)   #显示网格，第一个参数是X轴，第二个参数是Y轴
        self.grPCM.plotItem.showGrid(True, True, 0.7)
        self.maxFFT=0                                   #设置最大参数
        self.maxPCM=0
